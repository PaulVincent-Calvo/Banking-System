...
try:
    connection = mysql.connector.connect(
        host="localhost",
        user="admin", # put user that you used when you were setting up MySQL (default is root)
        password="user", # put password that you used when you were setting up mysql
        database="bankingoop" 
    )
