...
# NOTE: Make sure to replace the directory according to its folder assets according the frame0 path
...
class Customer_Page:
    ...
    def customer_mainframe(self, checkings_id, connection, cursor):
