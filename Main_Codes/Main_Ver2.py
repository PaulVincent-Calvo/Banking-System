...
class Customer(User): # NOTE: inherits from USER 
  ...
  def add_transaction_log(self, connection, checkings_id, transaction_type, receiving_account, amount):
    ...
    try:
      ...
      query = "INSERT INTO transactions(transactions_id, checkings_id, transaction_type, receiving_account, transaction_date, amount) VALUES(%s, %s, %s, %s, %s)"
    ...
    while True:
      ...
      if withdraw_amount <= current_balance and confirm_withdrawal:
        try:
          ...
          self.add_transaction_log(connection,checking_account_id, "Withdraw", "None", withdraw_amount)
    ...
    while True:
      ...
      if confirm_withdrawal:
        try:
          ...
          self.updating_query(connection, cursor, table, column, "checkings_id", checking_account_id, new_balance)
          self.add_transaction_log(connection, checking_account_id, "Deposit", "None", deposit_amount )
          ...
          while True: 
            ...
            try:
              ...
              if account_exists and recepient_checkAccID != my_checking_account_id: # NOTE: executing the transfer
                ...
                self.add_transaction_log(connection, my_checking_account_id, "Transfer", recepient_checkAccID, transfer_amount)
